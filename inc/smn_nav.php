...
function icon_nav_render_block_core (string $block_content, array $block)
{
	if ( 
		...
		$block_content = preg_replace('/<svg.*?<\/svg>/s', $svg, $block_content, 1);
